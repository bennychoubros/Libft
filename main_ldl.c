...
/*   Updated: 2017/11/15 18:31:31 by bviala           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#endif
#ifdef TEST_DEL_ID
	ft_ldl_del_id(ldl_list, 4, &ft_strdel);
	ft_ldl_del_id(ldl_list, 0, &ft_strdel);
	ft_ldl_del_id(ldl_list, 14, &ft_strdel);
	FT_LDL_DEL_FIRST(ldl_list, &ft_strdel);
	FT_LDL_DEL_LAST(ldl_list, &ft_strdel);
	ldl_debug_display_list(ldl_list);
#endif
#ifdef TEST_REV
//			DEBUG REV
...
#ifdef TEST_FIND
//			DEBUG FIND ALL
	ldl_list = ft_ldl_find(ldl_list, &ft_strncmp, 1, "b");
	ldl_debug_display_list(ldl_list);
#endif
